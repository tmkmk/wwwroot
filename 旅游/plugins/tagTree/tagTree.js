...
;(function($){
	...
	function setTree(data,that)
	{
		...
		$.each(data,function(index,value){
			let other='';
			if(value.id)other = ' id="'+value.id+'"';
			var li = $('<li><span '+value.other+other+'>'+value.name+'<i data-val="'+value.value+'" class="fa fa-check" style="display:none;"></i></span></li>');
			ul.append(li);
