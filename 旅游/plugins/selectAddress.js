...
(function() {
  ...
  app.directive('selectAddress', function($http, $q, $compile) {
    ...
    delay = $q.defer();
    templateURL = 'plugins/selectAddress/index.html';
    cityURL = 'plugins/selectAddress/city.min.js';
...
//dynamicLoading.css("plugins/selectAddress/bootstrap.min.css");
function loadfile(){
//	document.writeln("<link href='plugins/selectAddress/bootstrap.min.css' rel='stylesheet' type='text/css' />");
}
loadfile();