angular.module('wui.date',[]).directive('wuiDate', function() {
	...
	function fieldTemplate(scope, element, attr) {
		return(
			...
			'<input id="'+element.inputid+
			'" class="wui-input wui-input-block wui-date-input" type="text" placeholder="{{placeholder}}" ng-model="ngModel" autocomplete="off" ng-blur=checkDateFormat()>' +
